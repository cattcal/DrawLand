package com.demo.widget.layout
...
class SettingBar @JvmOverloads constructor(
    ...
    init {
        ...
        leftView.setLineSpacing(resources.getDimension(com.demo.base.R.dimen.dp_5), leftView.lineSpacingMultiplier)
        rightView.setLineSpacing(resources.getDimension(com.demo.base.R.dimen.dp_5), rightView.lineSpacingMultiplier)
        leftView.setPaddingRelative(
            resources.getDimension(com.demo.base.R.dimen.dp_15).toInt(),
            resources.getDimension(com.demo.base.R.dimen.dp_12).toInt(),
            resources.getDimension(com.demo.base.R.dimen.dp_15).toInt(),
            resources.getDimension(com.demo.base.R.dimen.dp_12).toInt()
        )
        ...
        setLeftDrawablePadding(
            if (array.hasValue(R.styleable.SettingBar_bar_leftDrawablePadding)) array.getDimensionPixelSize(
                ...
                0
            ) else resources.getDimension(com.demo.base.R.dimen.dp_10).toInt()
        )
        setRightDrawablePadding(
            if (array.hasValue(R.styleable.SettingBar_bar_rightDrawablePadding))
                ...
                resources.getDimension(com.demo.base.R.dimen.dp_10).toInt()
        )
        ...
        setLeftTextColor(
            array.getColor(
                ...
                ContextCompat.getColor(getContext(), com.demo.base.R.color.black80)
            )
        )
        setRightTextColor(
            array.getColor(
                R.styleable.SettingBar_bar_rightTextColor,
                ContextCompat.getColor(getContext(), com.demo.base.R.color.black60)
            )
        )

        // 文字大小设置
        setLeftTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(
            R.styleable.SettingBar_bar_leftTextSize, resources.getDimension(com.demo.base.R.dimen.sp_15).toInt()).toFloat())
        setRightTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(
            R.styleable.SettingBar_bar_rightTextSize, resources.getDimension(com.demo.base.R.dimen.sp_14).toInt()).toFloat())
        ...
        if (background == null) {
            ...
            drawable.addState(
                ...
                ColorDrawable(ContextCompat.getColor(getContext(), com.demo.base.R.color.black5))
            )
            drawable.addState(
            ...
            drawable.addState(
                intArrayOf(),
                ColorDrawable(ContextCompat.getColor(getContext(), com.demo.base.R.color.white))
            )
            background = drawable

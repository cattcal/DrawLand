...
class PlayButton @JvmOverloads constructor(
    ...
    init {
        ...
        val lineSize: Int = typedArray.getInteger(
            ...
            resources.getDimension(com.demo.base.R.dimen.dp_4).toInt()
        )
    ...
    override fun onSizeChanged(width: Int, height: Int, oldWidth: Int, oldHeight: Int) {
        ...
        circleRadius = width / resources.getDimension(com.demo.base.R.dimen.dp_4).toInt()
        centerX = width / 2
        centerY = height / 2
        rectF = RectF(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        when (MeasureSpec.getMode(finalWidthMeasureSpec)) {
            MeasureSpec.AT_MOST, MeasureSpec.UNSPECIFIED ->
                finalWidthMeasureSpec = MeasureSpec.makeMeasureSpec(resources.getDimension(com.demo.base.R.dimen.dp_60).toInt(), MeasureSpec.EXACTLY)
            MeasureSpec.EXACTLY -> {}
        }
        when (MeasureSpec.getMode(finalHeightMeasureSpec)) {
            MeasureSpec.AT_MOST, MeasureSpec.UNSPECIFIED ->
                finalHeightMeasureSpec = MeasureSpec.makeMeasureSpec(resources.getDimension(com.demo.base.R.dimen.dp_60).toInt(), MeasureSpec.EXACTLY)
            MeasureSpec.EXACTLY -> {}
        }

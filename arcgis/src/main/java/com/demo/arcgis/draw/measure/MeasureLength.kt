 ...
 * @desc 测量长度
 */
class MeasureLength(private val mMap: MapView?) : IMeasure {
    ...
    private fun drawLength() {
        ...
        val textSymbol = TextSymbol(
            16F,
            GeometryUtil.getLength(geometry).toEngineeringString() + "米", Color.BLACK,
    ...
    private fun drawLine() {
        ...
        val graphic = Graphic(geometry, lineSymbol)
        mGraphicsOverlay.graphics.add(graphic)
    }
    ...
    private val geometry: Geometry
        private get() {
            ...
            return Polyline(pointCollection)
        }

...
import com.demo.arcgis.draw.BaseDrawMapView
...
import com.demo.drawland.ui.dialog.WaitDialog
 ...
 * desc : Activity 业务基类
 */
abstract class BaseDrawActivity : BaseActivity(), ToastAction, TitleBarAction {
    ...
    protected var mBaseDrawMapView: BaseDrawMapView? = null
